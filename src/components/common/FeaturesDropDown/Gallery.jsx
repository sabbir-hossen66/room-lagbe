  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-5 grid-rows-3 gap-4">
        {/* First column: One image that takes up all three rows */}
        <div className="row-span-3 col-span-1">
          <img src={flatImages[0]} alt="Gallery Image" className="w-full h-[650px] object-cover rounded-md" />
        </div>

        {/* Second column: Three flatImages */}
        ...
        {/* Fourth column: Three flatImages */}
        <div className="col-span-1 grid grid-rows-3 gap-4">
